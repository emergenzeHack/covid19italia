...
Τα ελεύθερα [από τους περιορισμούς πρόσβασης] δεδομένα φιλοξενούνται από το GitHub, των οποίων οι διακομιστές βρίσκονται στις ΗΠΑ. Το GitHub είναι συμβατό με τον GDPR και εφαρμόζει το [Privacy Shield Framework](https://www.privacyshield.gov/welcome).
...
Τα περιγραφόμενα στα άρθρα 15-22 του GDPR δικαιώματα μπορούν να ασκηθούν ανά πάσα στιγμή αποστέλλοντας μήνυμα στον υπεύθυνο επεξεργασίας προσωπικών δεδομένων της ActionAid Ελλάς κο Χάρη Θανάσουλα στην ηλεκτρονική διεύθυνση [dpo.hellas@actionaid.org](mailto:dpo.hellas@actionaid.org) και στο τηλέφωνο: 212 000 6300
...
Το υποκείμενο των προσωπικών δεδομένων έχει το δικαίωμα να εκφράσει τη γνώμη του και να αμφισβητήσει την απόφαση της ActionAid Ελλάς. Η Πολιτική Απορρήτου του παρόντος ιστοτόπου υπόκειται σε ενημερώσεις. Συνεπώς, οι χρήστες καλούνται να ελέγχουν περιοδικά το περιεχόμενό τους.
...
Το περιεχόμενο κυκλοφόρησε υπό την άδεια [CC-BY 4.0](https://creativecommons.org/licenses/by/4.0/). Open Data
